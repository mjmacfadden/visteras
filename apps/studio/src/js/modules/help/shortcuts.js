	...
	shortcuts() {
		...
		var settings = {
			...
			params: [
				...
				{title: "Shift + G", value: 'Cycle Gradient ↔ Paint Bucket'},
				{title: "T", value: 'Text Tool'},
				{title: "P", value: 'Pen Tool'},
				{title: "C", value: 'Crop Tool'},
				{title: "S", value: 'Clone Tool'},
				{title: "Alt / Option + Click", value: 'Sample Clone Source'},
				{title: "M", value: 'Marquee Selection Tool'},
				{title: "Shift + M", value: 'Cycle Rectangular ↔ Elliptical Marquee'},
				...
				{title: "---", value: "Gradient Tool"},
				{title: "Click-drag", value: 'Set angle + scale (live preview)'},
				{title: "Shift", value: 'Constrain angle to 45°'},
				{title: "Alt / Option", value: 'Draw linear gradient from center'},
				{title: "---", value: "General"},
